        ...
        <div className="p-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              View all urgency alerts, critical cases, and aid distribution reports
            </p>
          </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-blue-900 dark:text-blue-100 mb-2">
                  Alert Dashboard Running on Port 3004
                </h3>
                <p className="text-blue-800 dark:text-blue-300 mb-4">
                  This dashboard shows all generated alerts, critical cases, and urgency scores calculated by the AI system. 
                  Filter by priority, view details, and take action on urgent cases.
                </p>
                <a
                  href="http://localhost:3004/dashboard.html"
                  target="_blank"
          ...
          <div className="bg-white dark:bg-neutral-800 rounded-xl shadow-lg border border-gray-200 dark:border-neutral-700 overflow-hidden">
            ...
            <div className="relative" style={{ height: 'calc(100vh - 400px)', minHeight: '600px' }}>
              <iframe
                src="http://localhost:3004/dashboard.html"
                className="w-full h-full border-0"
                title="Reports & Alerts Dashboard"
              />
            </div>
          </div>
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-700 rounded-lg p-4">
              <h3 className="font-semibold text-red-900 dark:text-red-100 mb-2">🚨 Critical Alerts</h3>
              <p className="text-sm text-red-800 dark:text-red-300">
                View and respond to high-priority cases (urgency ≥70).
              </p>
            </div>
            <div className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-700 rounded-lg p-4">
              <h3 className="font-semibold text-orange-900 dark:text-orange-100 mb-2">📊 Priority Sorting</h3>
              <p className="text-sm text-orange-800 dark:text-orange-300">
                Filter alerts by urgency level, date, or status.
              </p>
            </div>
            <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-700 rounded-lg p-4">
              <h3 className="font-semibold text-green-900 dark:text-green-100 mb-2">✅ Case Management</h3>
              <p className="text-sm text-green-800 dark:text-green-300">
                Mark cases as complete and track aid distribution.
              </p>
            </div>
            <div className="bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-700 rounded-lg p-4">
              <h3 className="font-semibold text-purple-900 dark:text-purple-100 mb-2">📈 Analytics</h3>
              <p className="text-sm text-purple-800 dark:text-purple-300">
                View trends and statistics across all alerts.
              </p>
            </div>
          </div>
          ...
          <div className="mt-8 bg-gray-50 dark:bg-neutral-800 rounded-xl p-6 border border-gray-200 dark:border-neutral-700">
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Urgency Level Legend</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">Immediate action required. Life-threatening situations.</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
